    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="<?php echo e(asset('sbadmin/img/undraw_rocket.svg')); ?>" alt="...">
...
<?php /**PATH /opt/lampp/htdocs/quiz_MuhammadJafarShiddiq/resources/views/layouts/master.blade.php ENDPATH**/ ?>